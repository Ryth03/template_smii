                    ...
                    success: function(response) {
                        ...
                        response.forms.forEach((form, index) => {
                            ...
                            table.row.add([
                                ...
                                ${form.status === 'Approved' && hasFileList.includes(form.id) ? `
                                    ...
                                    <div id="viewSioFile${index}" class="hidden bg-modal bg-opacity-50 fixed inset-0 z-50 flex justify-center items-center" style="z-index:1002">
                                        <div class="relative w-full max-w-lg bg-dark rounded-lg shadow">
                                            ...
                                            <div class="p-4">
                                                <div class="swiper-container overflow-hidden" style="width: 100%; height: 400px;">
                                                            ...
                                                            .map(file => {
                                                                ...
                                                                return `
                                                                    <div class="swiper-slide">
                                                                        ...
                                                                        ` : `
                                                                            <img src="${fileUrl}" width="100%" height="100%" style="max-height:75%;>
                                                                        `}
                                ...
                                <div class="flex space-x-2 my-2">
                                    <button class="flex-1 px-4 py-2 text-white bg-blue-500 rounded-lg hover:bg-blue-600"
                                    onClick="toggleModal('viewKtpFile${index}')">
                                        <label for="KTP">
                                            KTP
                                            <i class="fa-solid fa-file"></i>
                                        </label>
                                ...
                                <div id="viewKtpFile${index}" class="hidden bg-modal bg-opacity-50 fixed inset-0 z-50 flex justify-center items-center" style="z-index:1002">
                                    <div class="relative w-full max-w-lg bg-dark rounded-lg shadow">
                                        <div class="p-4 border-b flex justify-between">
                                            <h3 class="text-lg font-semibold">File KTP</h3>
                                            <button class="text-gray-400 hover:text-gray-600" onClick="toggleModal('viewKtpFile${index}')">✖</button>
                                        </div>
                                        <div class="p-4">
                                            <div class="swiper-container overflow-hidden" style="width: 100%; height: 400px;">
                                                <div class="swiper-wrapper">
                                                    ${ktps
                                                        .filter(ktp => ktp.form_id === form.id)
                                                        .map(ktp => {
                                                            const fileUrl = `${ktp.file_path}`;
                                                            return `
                                                                <div class="swiper-slide">
                                                                    <img src="${fileUrl}" width="100%" height="100%" style="max-height:75%;">
                                                                    <p class="text-center">${ktp.worker_name}</p>
                                                                </div>`;
                                                        })
                                                        .join('')}
                                                </div>
                                                ${ktps.filter(ktp => ktp.form_id === form.id).length > 1 ? `
                                                    <div class="swiper-button-next"></div>
                                                    <div class="swiper-button-prev"></div>
                                                ` : ''}
                                                <div class="swiper-pagination"></div>
