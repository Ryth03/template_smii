<x-guest-layout>
            ...
            <div class="login-card login-dark">
                <div class="w-full" style="max-width:450px;">
                    <div class="login-main"
                        style="background: rgba(255, 255, 255, 0.527); backdrop-filter: blur(10px); border-radius: 10px; box-shadow: 0 4px 6px rgba(0, 0, 0, 0.1); max-width: 450px; width:100%;">
                        <form class="theme-form" method="POST" action="">
                            ...
                            <div class="relative w-full mt-4">
                                <label for="input-label"
                                    class="block text-lg font-medium mb-2 text-gray-700">Name</label>
                            ...
                            <div class="relative w-full mt-4">
                                <label for="company_department"
                                    class="block text-lg font-medium mb-2 text-gray-700">Company / Department</label>
                            ...
                            <div class="relative w-full mt-4">
                                <label for="email"
                                    class="block text-lg font-medium mb-2 text-gray-700">E-mail</label>
                            ...
                            <!-- password -->
                            <x-input-label class="font-medium block mb-1 mt-4 text-gray-700" for="password"
                                :value="__('Password')" />
                            ...
                            <!-- confirm password -->
                            <x-input-label class="font-medium block mb-1 mt-4 text-gray-700" for="password_confirmation"
    ...
    <div id="createDepartmentModal" tabindex="-1" aria-hidden="true"
        class="hidden overflow-y-auto overflow-x-hidden fixed inset-0 z-50 flex items-center justify-center" style="z-index: 1002;">
        <div class="relative p-4 w-full max-w-lg max-h-full">
            <!-- Modal content -->
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700 font-sans" style="max-width: 100%; width: 100%; margin: auto;">
                <!-- Modal header -->
                <div class="flex flex-col p-4 md:p-5 border-b rounded-t dark:border-gray-600">
                    ...
                    <label class="text-justify block mt-4 text-gray-900 dark:text-white">
                        Dalam hal ini menerangkan bahwa kedua belah pihak sepakat mengadakan sebuah perjanjian kerja
                ...
                <div class="p-4 md:p-5">
                    <div class="text-justify  text-gray-900 dark:text-white">
                        ...
                        <ol class="p-2.5 space-y-2.5 list-decimal">
                            <li>Melaporkan dan menyerahkan fotocopy KTP / Identitas Diri yang berlaku kepada
                                <strong>PIHAK PERTAMA</strong>.</li>
                            <li>Selama melakukan pekerjaan di area PT Sinar Meadow International Indonesia wajib memakai
                                APD Standar, seperti:
                            ...
                            <li>Mentaati semua persyaratan yang tertuang dalam surat ijin kerja dan yang di persyaratkan
                                oleh <strong>PIHAK PERTAMA</strong>.</li>
                            <li>Mentaati semua peraturan umum yang berlaku di PT Sinar Meadow International Indonesia.
                            </li>
                            <li>Memperhatikan dan mematuhi setiap rambu yang dipasang di area PT Sinar Meadow
                                International Indonesia.</li>
                            ...
                            <li>Melaporkan kepada pihak PT Sinar Meadow International Indonesia jika terjadi kecelakaan
                                kerja.</li>
                            <li>Dilarang meninggalkan area kerja dalam kondisi kotor dan berantakan.</li>
                            <li>Menjaga kebersihan di lingkungan PT Sinar Meadow International Indonesia, dengan
                                membuang sampah di tempat sampah yang telah disediakan.</li>
                        ...
                        <ol class="p-2.5 space-y-2.5 list-decimal">
                            <li>Memberikan safety induction diawal proyek sebelum pekerjaan dimulai kepada <strong>PIHAK
                                    KEDUA</strong>.</li>
                            <li>Melakukan pengawasan dilapangan secara berkala di area proyek.</li>
                            <li>Apabila dalam melakukan aktivitas pekerjaan di area PT Sinar Meadow International
                                Indonesia <strong>PIHAK KEDUA</strong> dengan sengaja tidak mematuhi peraturan /
                                tata-tertib point 1-10,
                        ...
                        <div class="block mt-3 mb-2">
                            ...
                            <div>
                                ...
                                <ol class="pl-2.5 list-inside" style="list-style-type: lower-alpha;">
                                    <li>Menimbulkan Kecelakaan Kerja yang berdampak kematian bagi pekerja <strong>PIHAK
                                            PERTAMA</strong> maupun <strong>PIHAK KEDUA</strong>.</li>
                                    <li>Kerusakaan asset/property milik <strong>PIHAK PERTAMA</strong>.</li>
                                    <li>Pencemeran lingkungan di sekitar area perusahaan <strong>PIHAK PERTAMA</strong>.
                                    </li>
                                </ol>
                                Maka sepenuhnya menjadi tanggung jawab <strong>PIHAK PERTAMA</strong> dalam
                        ...
                        <div class="flex items-center justify-center">
                            <button type="button" data-modal-hide="createDepartmentModal"
                                class="bg-gray-500 text-white font-semibold py-2 px-4 rounded-lg shadow-md hover:bg-gray-600 focus:outline-none focus:ring-2 focus:ring-gray-400 focus:ring-opacity-75 transition duration-200">
                                <span>Close</span>
                            </button>
                        </div>
                    </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // Mencegah modal menutup saat mengklik di dalam modal
