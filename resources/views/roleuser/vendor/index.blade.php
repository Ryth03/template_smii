            ...
            <div class="inline-flex items-center">
                <nav>
                    <ol class="breadcrumb flex items-center">
                        ...
                        <li class="breadcrumb-item pr-1">Vendors</li>
    ...
    <section class="content">
        ...
        <div class="card">
            <div class="card-header">
                <h1 class="card-title text-2xl font-medium">List Vendors</h1>
            </div>
            <div class="card-body">
                    ...
                    <table id="usersTable" class="table table-striped w-full text-left rtl:text-right table-bordered">
                        <thead class="uppercase border-b">
                            <tr>
                                ...
                                <th scope="col" class="px-6 py-3 text-lg">Company</th>
                        ...
                        <tbody>
                            @foreach ($users as $user)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 text-lg">{{ $user->company_department }}</td>
        ...
        <div class="relative p-4 w-full max-w-4xl max-h-full">
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700" style="margin-top: 10%;">
                ...
                <div class="p-4 md:p-5">
                    ...
                    @endif
                    <form class="space-y-4" action="{{ route('vendors.store') }}" method="POST" id="createUserForm">
                        @csrf
                        <div class="grid grid-cols-2 gap-4">
                            <div class="form-group">
                                <label class="form-label text-white text-xl">Company<span
                            ...
                            <div class="form-group">
                                <label class="form-label text-white text-xl">Password<span
                                    class="text-danger">*</span</label>
                                <div class="controls">
